...
<head>
    ...
    <!-- CDN -->
    <!-- stylesheets -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>application/views/plugins/jquery/jquery.mobile-1.4.5.min.css" />
...
<!--    <script src="--><?php //echo base_url().'application/views/';?><!--js/jquery-3.3.1.min.js"></script>-->
    <script src="<?php echo base_url().'application/views/';?>plugins/jquery/jquery-2.2.4.min.js"></script>
    <script src="<?php echo base_url().'application/views/';?>js/jquery-ui.min.js"></script>
    <script src="<?php echo base_url().'application/views/';?>plugins/jquery/jquery.mobile-1.4.5.min.js"></script>
