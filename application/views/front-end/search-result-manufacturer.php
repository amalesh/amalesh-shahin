...
<section class="product">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="add-manufacturer-page-inner-left-523x52"></div>
            </div>
            <div class="col-md-6">
                <div class="add-manufacturer-page-inner-right-523x52"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="add-manufacturer-page-bottom-left-823x115"></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="add-manufacturer-page-top-right-340x355"></div>
